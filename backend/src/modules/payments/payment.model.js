...
const paymentSchema = new mongoose.Schema({
  ...
  provider: { type: String, enum: ['PAYMOB'], default: 'PAYMOB' },
  paymobIntentionId: { type: String, default: '' },
  paymobOrderId: { type: String, default: '', index: true },
  paymobTransactionId: { type: String, default: '', index: true },
